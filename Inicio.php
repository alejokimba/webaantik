...
<body>
    <header>
         ...
         <nav class="navbar navbar-expand-lg fixed-top " style="background-color:white">
            ...
            <a class="navbar-brand" href="#" id="logo-menu"><img class="img-fluid" src="Imagenes/simboloaantik.png" alt="" width="50" height="30"></a> 
                ...
                <div class="redessoc">
                 ...
                 <div class="redessoc">
                    ...
                    <ul class="navbar-nav">
                        ...
                        <li class=" nav-item d-flex justify-content-center " ><a href="./Inicio.php" id="logo"><img src="Imagenes/simboloaantik.png" alt="" style="width:60%;"></a></li>
                                                ...
                                                <div class="form-row">
                                                    ...
                                                    <div class="container" style="margin-top: 20px;">
                                                        <div class="row">
                                                            ...
                                                            <div class="col">
                                                                <button type="button" class="btn btn-secondary btn-cerrar" onclick="cerrarModal()" >Cerrar</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="flip-card">
                                        <div class="flip-card-inner">
                                            <div class="flip-card-front">
                                                ...
                                                <div class="icono">
                                                    <img src="Imagenes\tablero de indicadores.png" alt="" style="width: 200px;">
                                                </div>
