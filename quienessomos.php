...
<body>
           ...
           <div class="container-fluid menu">
               ...
               <div class="collapse navbar-collapse" id="navbarSupportedContent">
                   <ul class="navbar-nav">
                       ...
                       <li class="nav-item"><a class="nav-link" href="dashboard.php">Vista Aantik al mercado</a></li>
                       <?php
    ...
    <figure class="textcenter">
     ...
     <div class="container-fluid">
        ...
        <!-- <div class="row nosotros">
                <div class="col-sm">
                    <div class="flip-card">
                        <div class="flip-card-inner">
                            <div class="flip-card-front">
                                <img class="img-fluid" src="Imagenes/joseeduardo.png" alt="" style="width: 100%;">
                                José Eduardo Ceballos Jurado
                ...
                <div class="col-sm">
                    <div class="flip-card">
                        <div class="flip-card-inner">
                            <div class="flip-card-front">
                                <img class="img-fluid" src="Imagenes/jaquie.png" alt="" style="max-width: 100%">
                                Jaqueline
                            </div>
       ...
       <!--  <div id="equipo" class="container">
            <div class="row">
                ...
                <div class="col-sm">
                    <div class="flip-card">
                        <div class="flip-card-inner">
                            <div class="flip-card-front2">
                                <img class="img-fluid" src="Imagenes/pau.jpeg" alt="">
                                <div class="nombre">
                                    Stefanie Paulina Jiménez Tapia
                                </div>
                               
                            </div>
                            <div class="flip-card-back2" id="pau" >
                                <div class="container">
                                    Financiera por la Universidad del Valle de México, ha brindado asesoría a PYMES en diferentes partes del país, en industrias como logística, de alimentos y bebidas, hidrocarburos, servicios de cuidado personal, agroindustrial, servicios educativos, entre otros.
                                    Con la convicción firme de que las PYMES son el motor de Latinoamérica y que la tecnología les puede acercar los servicios de consultoría, coliderea Aantik creando contenido educativo, analizando y asesorando financieramente a los clientes de la firma.
                                    Disfruta de hacer ejercicio en especial correr y jugar futbol, así como de leer, uno de sus libros favoritos es "La vocecita" de Blair Singer.
                ...
                <div class="col-sm">
                    <div class="flip-card">
                        <div class="flip-card-inner">
                            <div class="flip-card-front2">
                                <img class="img-fluid" src="Imagenes/Alex.png" alt="" style="width: 65%;">
                            </div>
                            <div class="flip-card-back2">
                                Ingeniero certificado de Azure Cloud con 6 años de experiencia en implementación, administración, soporte y supervisión de entornos de MS Azure. Clientes como SAT, América Móvil, Univision, Cinépolis y municipio de Nezahualcóyotl, y proyectos en conjunto con algunos Partners de Microsoft y Microsoft mismo.
                            </div>
            ...
            <div class="row">
                <div class="col">
                    <img class="img-fluid" src="Imagenes/joseeduardo.png" alt="">
                </div>
                <div class="col">
                    <img class="img-fluid" src="Imagenes/jaquie.png" alt="">
                </div>
                <div class="col">
                    sd
                </div>
 ...
 -->
        ...
        <div id="socios" class="container">
            <div class="row justify-content-center">
                <div class="col-sm socios">
                    <div class="flip-card2">
                        <div class="flip-card-inner2">
                            <div class="flip-card-front2">
                                <img class="img-fluid mx-auto d-block rounded" src="Imagenes\alejandromartinez.png" alt="" style="width: 70%;">
                                <h2>Alejandro Martínez López</h2>
                            </div>
                                
                            <div class="socios-card-back">
                                <div class="descripcion-socios">
                ...
                <div class="col-sm socios">
                    <div class="flip-card2">
                        <div class="flip-card-inner2">
                            <div class="flip-card-front2">
                                <img class="img-fluid mx-auto d-block rounded" src="Imagenes\gersonlozano.png" alt="" style="width: 70%;">
                                <h2>Gerson Lozano</h2>
                            </div>
