        ...
        <form id="regFormPF" method="POST" name="regFormPF" action="scripts\formulariopf.php">
          ...
          <div class="tab"><h2>De las garantias o referencias inmobiliarias</h2>
            ...
            <p><input type="file" name="pdf_escrituraspf" oninput="this.className = ''"/></p>
              ...
              <p>Estados financieros internos con firma autógrafa de su represéntate legal y contador, incluyendo, relaciones analíticas de las principales cuentas, con una antigüedad no mayor a 60 días.</p>
              <br>
              <ul class="list-group list-group-flush">
          ...
          <div class="tab">
            ...
            <p>*Seleccionar solamente archivos en formato .pdf</p>
            <p>Copias fotostáticas legibles de las declaraciones de impuestos 2019 (con cadena de recepción)</p>
            <p><input type="file" name="pdf_impuestos19pf" oninput="this.className = ''"/></p>
            <p>Copias fotostáticas legibles de las declaraciones de impuestos 2020 (con cadena de recepción)</p>
            <p><input type="file" name="pdf_impuestos20pf" oninput="this.className = ''"/></p>
            <p>Copias fotostáticas legibles de la cédula de identificación fiscal y alta ante la SHCP</p>
            ...
            <div class="cuenta-bancaria">
              <p>Copias fotostáticas de los doce últimos estados de cuenta bancarios del solicitante. (Caratulas)</p>
              <ul class="list-group list-group-flush">
        ...
        <form id="regFormPM" name="regFormPM" action="scripts/formulariopm.php">
          ...
          <div class="tab"><h2>Documentaci&oacute;n:</h2>
            <div class="g1">
              ...
              <p>Copias fotost&aacute;ticas legibles de doctos que acrediten el domicilio particular y de negocio (telefon&iacute;a fija) con una antigüedad no mayor a 60 días.</p>
              <div class="radio-container">
